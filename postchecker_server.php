 ...
 * Foundation; either version 2 of the License, or ($file, at your option) any later version.
 *
...
fwrite($file, "<title>PostChecker - 1.0</title>\n");
fwrite($file, "</head>\n");
fwrite($file, "<body>\n");
fwrite($file, "<h1>PostChecker - 1.0</h1>\n");
